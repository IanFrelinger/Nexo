...
"$UNITY" \
  ...
  -projectPath "$PROJ" \
  -executeMethod NexoDirectorStudio.Editor.SimpleGameSpecWizard.RunWizard \
  -logFile "$ART/unity-game-spec-wizard.log" \
  -quit

echo ""
echo "📊 Game Specification Wizard Results:"
...
echo ""
echo "📋 Log file: $ART/unity-game-spec-wizard.log"
