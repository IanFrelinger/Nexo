...
echo "  • Same preflight:     dotnet run --project src/Nexo.CLI -- release preflight ${VER}"
echo "  • Dispatch CI:        dotnet run --project src/Nexo.CLI -- release dispatch ${VER}   (or: make release-dispatch VERSION=${VER})"
