...
namespace NexoDirectorStudio.Profiles
{
    ...
    public sealed class PlatformerProfile : IGenreProfile
    {
        ...
        {
            new AssetRequirement("Platform", "Basic Platform", "Standard platform for jumping", true, 5),
            new AssetRequirement("Platform", "Moving Platform", "Platform that moves or rotates", false, 3),
            new AssetRequirement("Collectible", "Coin", "Collectible items for the player", true, 4),
            new AssetRequirement("Hazard", "Spike Trap", "Hazardous obstacles", false, 2),
            new AssetRequirement("Powerup", "Jump Boost", "Power-up to enhance jumping", false, 3)
        };
