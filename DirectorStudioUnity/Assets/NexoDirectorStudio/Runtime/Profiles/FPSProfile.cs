...
namespace NexoDirectorStudio.Profiles
{
    ...
    public sealed class FPSProfile : IGenreProfile
    {
        ...
        {
            new AssetRequirement("Weapon", "Primary Weapon", "Main weapon for the player", true, 5),
            new AssetRequirement("Weapon", "Secondary Weapon", "Backup weapon for the player", false, 3),
            new AssetRequirement("Enemy", "Enemy AI", "AI enemies to fight", true, 4),
            new AssetRequirement("Environment", "Cover Objects", "Objects to take cover behind", true, 4),
            new AssetRequirement("Audio", "Weapon Sounds", "Audio for weapon firing and reloading", true, 3)
        };
