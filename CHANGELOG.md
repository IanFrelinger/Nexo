...
- **Kernel Tier A and Ship Tier A host-DI smoke are counted.** `scripts/kernel-gate-tier-a.sh` floors hosting/E2E (40) and pipeline lifecycle (14). Ship Tier A floors the two named DI facts. `docs/OpenCoreBoundary.md` census is 108/100/8/21. Autonomy objectives write under `samples/dogfood/` instead of the removed `applications/` tree.
