...
public class Parity_Local_And_Cloud
{
    ...
    public async Task Labels_Are_Semantically_Similar_Across_Providers()
    {
        ...
        var localResult = await DemoHarness.RunScenarioAsync(scenarioPath);
        ...
        if (!string.IsNullOrEmpty(apiKey))
        {
            ...
            var cloudResult = await DemoHarness.RunScenarioAsync(scenarioPath);
    ...
    public async Task Provider_Switching_Does_Not_Require_Recipe_Changes()
    {
        ...
        {
            Environment.SetEnvironmentVariable("NEXO_AI_MODE", "hybrid");
            Environment.SetEnvironmentVariable("NEXO_PROVIDER", provider);
