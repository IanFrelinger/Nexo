...
```json
{
  ...
  "policyVersion": "1.0.0",
  "producerAgentId": "ashlar-demo-agent",
...
NEO4J_PASSWORD=<password> dotnet run --project tools/Ashlar.Provenance.Demo/Ashlar.Provenance.Demo.csproj
```
...
ASHLAR_RUN_NEO4J_CONTAINER=1 dotnet test applications/Ashlar.Provenance.Graph.Tests/Ashlar.Provenance.Graph.Tests.csproj --filter "Category=Integration"
```
...
No existing Ashlar project takes a hard reference to Neo4j unless it explicitly opts in.
