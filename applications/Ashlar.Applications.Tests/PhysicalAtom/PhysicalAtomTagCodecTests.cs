...
public sealed class PhysicalAtomTagCodecTests
{
    ...
    {
        var result = PhysicalAtomQrTagCodec.TryDecode("https://example.com/not-a-ashlar-tag", out _, out var code, out _);
    ...
    {
        var result = PhysicalAtomQrTagCodec.TryDecode("ashlar-atom:v1:!!!not-base64url!!!", out _, out var code, out _);
