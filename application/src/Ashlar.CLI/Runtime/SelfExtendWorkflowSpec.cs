...
/// <summary>Iteration and QA gate settings for self-extend workflow execution.</summary>
public sealed record SelfExtendWorkflowSpec
{
    ...
    /// <summary>Run visual validation tests via `ashlar test --visual` (requires visual model setup).</summary>
