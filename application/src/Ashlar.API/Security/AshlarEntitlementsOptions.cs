...
/// </summary>
public sealed class AshlarEntitlementsOptions
{
    /// <summary>Configuration section path (<c>Ashlar:Entitlements</c>).</summary>
    public const string SectionPath = "Ashlar:Entitlements";
