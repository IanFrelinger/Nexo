...
/// <summary>
/// User-configurable security posture hints for Ashlar.API (appsettings / environment). Does not replace firewalls or Tailscale ACLs.
/// </summary>
public sealed class AshlarSecurityOptions
{
    /// <summary>Configuration section path (<c>Ashlar:Security</c>).</summary>
    public const string SectionPath = "Ashlar:Security";
    ...
    /// </summary>
    public string ApiKeyHeaderName { get; set; } = "X-Ashlar-Api-Key";
    ...
    /// </summary>
    public string AuthorizationMode { get; set; } = nameof(AshlarAuthorizationMode.None);

    /// <summary>
    /// Scope for built-in authorization checks: MutatingApi or AllApi.
    /// </summary>
    public string AuthorizationScope { get; set; } = nameof(AshlarAuthorizationScope.MutatingApi);
