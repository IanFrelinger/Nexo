...
/// </summary>
public static class AshlarHttpOrg
{
    /// <summary>Default user header name (<c>X-Ashlar-User</c>).</summary>
    public const string UserHeaderName = "X-Ashlar-User";

    /// <summary>Default organization header name (<c>X-Ashlar-Org</c>).</summary>
    public const string OrgHeaderName = "X-Ashlar-Org";

    /// <summary>Resolves the authenticated user ID from request headers.</summary>
    public static bool TryResolveUser(HttpRequest request, AshlarProductOptions options, out string userId, out string? errorDetail)
    {
        userId = "";
        errorDetail = null;
