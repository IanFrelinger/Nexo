...
/// Kept as a separate small options class so <see cref="AshlarApiKeyAuthMiddleware"/> stays
/// decoupled from the protocol adapter packages.
/// </summary>
public sealed class AshlarProtocolIngressOptions
{
    /// <summary>
    /// Mirror of <c>Ashlar:A2A:Server:AllowAnonymousAgentCard</c>: when true, agent-card discovery
