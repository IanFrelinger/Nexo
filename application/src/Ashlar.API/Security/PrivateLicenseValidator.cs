...
public sealed class PrivateLicenseValidator : IPrivateLicenseValidator
{
    ...
    private readonly AshlarPrivateLicenseOptions _options;
    ...
    public PrivateLicenseValidator(
        IOptions<AshlarPrivateLicenseOptions> optionsAccessor,
    ...
    {
        var env = Environment.GetEnvironmentVariable("ASHLAR_LICENSE_FILE");
