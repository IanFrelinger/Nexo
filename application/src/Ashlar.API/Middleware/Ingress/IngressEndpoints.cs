...
public static class IngressEndpoints
{
    ...
    public static WebApplication MapIngressEndpoints(this WebApplication app)
    {
        ...
        ingressGroup.MapGet("/ingress-context", (IAshlarIngressAccessor ingress) =>
        ...
        app.MapPost("/api/ingress/sms/simulate", HandleSmsSimulateAsync)
            ...
            .RequireRateLimiting("ashlar-sms-ingress-posts");
    ...
    private static async Task<IResult> HandleSmsSimulateAsync(
        ...
        [FromServices] IOptionsMonitor<AshlarMiddlewareIngressOptions> optsMonitor,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var tenantId = httpContext.Request.Headers["X-Ashlar-Tenant"].FirstOrDefault();
        ...
        var appId = body.AppId ?? httpContext.Request.Headers["X-Ashlar-App-Id"].FirstOrDefault();
    ...
    {
        var opts = context.RequestServices.GetRequiredService<IOptionsMonitor<AshlarMiddlewareIngressOptions>>().CurrentValue;
        ...
        var tenantHeader = context.Request.Headers["X-Ashlar-Tenant"].FirstOrDefault();
        ...
        var hello = JsonSerializer.Serialize(new { type = "hello", correlationId = correlation, transport = AshlarIngressTransports.WebSocket });
