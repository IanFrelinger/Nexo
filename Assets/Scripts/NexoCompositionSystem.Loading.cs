...
{
    /// <summary>
    /// Asset loading functionality for NexoCompositionSystem.
    /// </summary>
    public partial class NexoCompositionSystem
    {
        /// <summary>
        /// Loads generated scripts
        /// </summary>
        ...
        private IEnumerator LoadGeneratedAssets()
        {
            ...
            try
            {
                ...
                {
                    // Load textures
                    yield return StartCoroutine(LoadTextures(assetsPath));
                    
                    // Load models
                    yield return StartCoroutine(LoadModels(assetsPath));
                    
                    // Load audio
                    yield return StartCoroutine(LoadAudio(assetsPath));
        ...
        /// </summary>
        private IEnumerator LoadTextures(string assetsPath)
        {
        ...
        /// Loads model assets
        /// </summary>
        private IEnumerator LoadModels(string assetsPath)
        {
        ...
        /// Loads audio assets
        /// </summary>
        private IEnumerator LoadAudio(string assetsPath)
        {
