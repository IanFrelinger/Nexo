# Nexo Mesh add-on (commercial SKU sketch)
...
| Hourly copilot quota | `Nexo:Entitlements:MaxCopilotSubmissionsPerHour` | Metering / billing hook TBD |
...
- **Order form**: seat count × mesh peer count cap (enforce in license file / `Nexo:Product` options — future).
