...
`-f net10.0` is optional here — `Nexo.API` targets `net10.0` only — but harmless, and it keeps the command identical to the one in `docs/GettingStarted.md`.
