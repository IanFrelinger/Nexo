...
| [Host bridge and artifact sinks](host-bridge-and-artifact-sinks.md) | Localhost NDJSON host bridge, evidence bundles, and provider-agnostic artifact upload ports. |
