...
| [.NET SDK and target frameworks](DotnetVersions.md) | Why `global.json`, CI, containers, and repo projects use .NET SDK 8.x / `net8.0`, with documented `netstandard2.0` compatibility targets where needed. |
