...
| [SDK migration plan (remaining gaps)](SdkMigrationPlan.md) | Phased partial-class split for `AddNexo`; incremental `Nexo.Infrastructure` `Sdk/` folders by subsystem. **Execution status** table at top of that doc. |
