...
**Idea:** Nexo stays HTTP on `peer-a:8080`; **Caddy** terminates HTTPS on the lab bridge ([`deploy/compose/docker-compose.mesh-lab-tls.override.yml`](../deploy/compose/docker-compose.mesh-lab-tls.override.yml)).
