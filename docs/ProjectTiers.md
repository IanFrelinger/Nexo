...
| Project | Role |
|---------|------|
| `products/ashlar-workstation/src/Ashlar.Workstation/Ashlar.Workstation.csproj` | Air-gapped IDE daemon composition (`SecureWorkstation` + trust) |
...
| `products/Ashlar.Products.sln` | Extractable product scaffolds | Workstation, cluster, cloud, native, and their tests |
