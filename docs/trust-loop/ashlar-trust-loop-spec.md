# Ashlar Trust Loop — Specification v1.0

Status: Draft for integration
Scope: Applies to any Ashlar subsystem in which a model proposes artifacts
...
and "proposer" carry their standard Ashlar meanings.
