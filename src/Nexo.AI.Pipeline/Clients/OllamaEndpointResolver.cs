...
/// <c>NEXO_OLLAMA_BASE_URL</c> / <c>NEXO_OLLAMA_MODEL</c> env →
/// <c>Nexo:Meai:OllamaBaseUrl</c> / <c>Nexo:Meai:OllamaModel</c> config →
...
public static class OllamaEndpointResolver
{
    ...
    /// <param name="options">Bound <c>Nexo:Meai</c> options; may be null when the section is absent.</param>
