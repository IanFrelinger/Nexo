...
/// <summary>
/// DI composition for the outbound A2A transport. Host-composed before <c>AddAshlar()</c>
/// (never kernel-registered) so the preview A2A dependency stays out of the AddAshlar package
/// graph and the pack-graph alignment gate.
/// </summary>
public static class AshlarA2ATransportServiceCollectionExtensions
{
    /// <summary>
    ...
    /// <c>Ashlar:A2A:Transport:Enabled</c> is true in <paramref name="configuration"/> — the
    ...
    /// </summary>
    public static IServiceCollection AddAshlarA2ATransport(
