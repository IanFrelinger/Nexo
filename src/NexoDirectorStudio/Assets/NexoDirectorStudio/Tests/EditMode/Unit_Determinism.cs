...
namespace NexoDirectorStudio.Tests.EditMode
{
    ...
    public class Unit_Determinism
    {
        ...
        public void SameBriefAndSeed_ShouldProduceIdenticalGamePlanHash()
        {
            ...
            var result1 = command.ExecuteAsync(brief, CancellationToken.None).Result;
            var result2 = command.ExecuteAsync(brief, CancellationToken.None).Result;
        ...
        public void DifferentSeeds_ShouldProduceDifferentResults()
        {
            ...
            // Act
            var result1 = command.ExecuteAsync(brief1, CancellationToken.None).Result;
            var result2 = command.ExecuteAsync(brief2, CancellationToken.None).Result;
        ...
        public void SameSeedDifferentDescription_ShouldProduceDifferentResults()
        {
            ...
            var brief2 = brief1 with { Description = "A relaxing puzzle game with blocks" };
        ...
        public void GamePlanHash_ShouldBeStableAcrossRuns()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                var result = command.ExecuteAsync(brief, CancellationToken.None).Result;
