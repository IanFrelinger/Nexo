...
/// <summary>
/// Central orchestrator between the MCP server handlers and Nexo tool contributors.
///
...
/// </summary>
public sealed class NexoMcpToolBridge
{
    ...
    private readonly ILogger<NexoMcpToolBridge> _logger;
    ...
    private sealed record CatalogEntry(NexoMcpToolDescriptor Descriptor, IMcpToolContributor Contributor);

    /// <summary>Creates the bridge over all registered contributors.</summary>
    public NexoMcpToolBridge(
        ...
        ILogger<NexoMcpToolBridge> logger)
    {
