...
/// <summary>
/// Options for exposing Nexo tools over the Model Context Protocol.
///
...
/// </summary>
public sealed class NexoMcpServerOptions
{
    /// <summary>Default configuration section (<c>Nexo:Mcp:Server</c>).</summary>
    public const string SectionPath = "Nexo:Mcp:Server";
    ...
    /// <summary>
    /// Explicit allowlist of Nexo tool ids (e.g. <c>repo.fs.read</c>) to expose over MCP.
    ...
    public string ServerName { get; set; } = "nexo";
    ...
    /// <summary>
    /// Repository root seeded into the <see cref="Nexo.Abstractions.WorldSnapshot"/> handed to
    ...
    /// <summary>
    /// Upper bound on concurrently executing MCP-originated tool calls. Existing Nexo tools were
    ...
    /// <summary>
    /// Per-tool argument overrides force-applied by the bridge before invocation, keyed by Nexo
