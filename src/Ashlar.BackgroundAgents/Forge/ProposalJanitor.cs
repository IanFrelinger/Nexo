...
/// <c>ashlar background-agent proposals list --status Stale</c> and either
...
public sealed class ProposalJanitor
{
        ...
        Func<DateTimeOffset>? now = null)
    {
        ...
        _proposedTtl = proposedTtl ?? ReadEnvSpan("ASHLAR_FORGE_PROPOSED_TTL_HOURS", DefaultProposedTtl);
        _approvedTtl = approvedTtl ?? ReadEnvSpan("ASHLAR_FORGE_APPROVED_TTL_HOURS", DefaultApprovedTtl);
