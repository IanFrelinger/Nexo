...
public static class RuntimeServiceCollectionExtensions
{
    ...
    /// </remarks>
    public static IServiceCollection AddAshlarRuntimeTransport<TInProcessTransport, TRemoteTransport>(
    ...
    /// </summary>
    public static IServiceCollection AddAshlarRuntimeRouting(
        this IServiceCollection services,
        IConfiguration configuration)
    {
        services.AddOptions<BarrierOptions>()
            .Configure(options =>
            {
                configuration.GetSection("Ashlar:Barriers").Bind(options);
                EnsureBarrierLevels(options);
            });
        services.AddOptions<RoutingOptions>()
            .Configure(options => configuration.GetSection("Ashlar:Routing").Bind(options));
        ...
        IConfiguration configuration)
    {
        ...
        var sinkNames = configuration.GetSection("Ashlar:Audit:Sinks").Get<string[]>() ?? [];
            ...
            switch (sinkName)
            {
                case "File":
                    ...
                    services.AddOptions<FileBarrierAuditSinkOptions>()
                        .Configure(options => configuration.GetSection("Ashlar:Audit:File").Bind(options));
                ...
                case "StructuredLog":
                    services.AddOptions<StructuredLogBarrierAuditSinkOptions>()
                        .Configure(options => configuration.GetSection("Ashlar:Audit:StructuredLog").Bind(options));
        ...
        IConfiguration configuration)
    {
        ...
        services.AddOptions<BarrierIdentityResolverOptions>()
            .Configure(options => configuration.GetSection("Ashlar:Identity").Bind(options));
        services.AddOptions<PkiCertificateResolverOptions>()
            .Configure(options => configuration.GetSection("Ashlar:Identity:PkiCertificate").Bind(options));
        services.AddOptions<JwtClaimResolverOptions>()
            .Configure(options => configuration.GetSection("Ashlar:Identity:JwtClaim").Bind(options));
        services.AddOptions<ApiKeyResolverOptions>()
            .Configure(options => configuration.GetSection("Ashlar:Identity:ApiKey").Bind(options));
        ...
        var resolverPriority = configuration.GetSection("Ashlar:Identity:ResolverPriority").Get<string[]>() ?? [];
