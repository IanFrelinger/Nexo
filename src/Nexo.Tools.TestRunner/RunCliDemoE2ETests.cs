...
/// <summary>
/// Runs the CLI demo E2E tests directly via TestRunnerAdapter.
/// </summary>
internal static class RunCliDemoE2ETests
{
    public static async Task<int> RunAsync(string[] args)
    {
        var loggerFactory = LoggerFactory.Create(builder =>
            builder.AddConsole().SetMinimumLevel(LogLevel.Information));
        var logger = loggerFactory.CreateLogger("DemoCliE2E");

        logger.LogInformation("========================================");
        logger.LogInformation("Running CLI Demo E2E Tests");
        logger.LogInformation("========================================");
        logger.LogInformation("");
        ...
        try
        {
            var result = await testRunner.RunTestsAsync("DemoCliE2ETests", null, CancellationToken.None);
