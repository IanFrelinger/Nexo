...
/// <summary>
/// Cross-cutting ingress metadata adapters map into before invoking Ashlar use cases.
...
/// <param name="Transport">Ingress transport label; see <see cref="AshlarIngressTransports"/>.</param>
...
public sealed record AshlarIngressEnvelope(
    ...
    string? AppId = null)
{
    ...
    /// </summary>
    public const string HttpContextItemKey = "Ashlar.IngressEnvelope";
}
