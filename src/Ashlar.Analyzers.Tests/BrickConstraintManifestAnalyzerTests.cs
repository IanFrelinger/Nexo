...
public sealed class BrickConstraintManifestAnalyzerTests
{
    ...
    // --- ASHLAR0011: forbidden API tokens --------------------------------------------------
    ...
    {
        // Distinct from ASHLAR0007: the manifest token bans the TYPE, so even a deterministic
    ...
    // --- ASHLAR0012: forbidden namespaces --------------------------------------------------
