namespace Nexo.Core.Application.Enums
{
    ...
    public enum LogLevel
    {
        ...
        /// <summary>
        /// Logs that highlight when the current flow of execution is stopped due to a failure. These should indicate
        /// a failure in the current activity, not an application-wide failure.
        /// </summary>
        Error = 4,
