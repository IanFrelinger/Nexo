...
public class ContractsDtoTests
{
    ...
    {
        AshlarIngressTransports.Http.Should().Be("http");
        AshlarIngressTransports.Mcp.Should().Be("mcp");
        AshlarIngressTransports.A2A.Should().Be("a2a");
        new AshlarIngressEnvelope("c1", AshlarIngressTransports.WebSocket, "idem", "v1", "t1", "app")
    ...
    {
        SmsIngressDynamoDbOptions.SectionPath.Should().Be("Ashlar:SmsIngressDynamoDb");
    ...
    public void Contracts_records_touch_all_properties_for_coverage()
    {
        ...
        var envelope = new AshlarIngressEnvelope("c1", AshlarIngressTransports.Http, "idem", "v1", "tenant", "app");
        envelope.CorrelationId.Should().Be("c1");
        envelope.Transport.Should().Be(AshlarIngressTransports.Http);
