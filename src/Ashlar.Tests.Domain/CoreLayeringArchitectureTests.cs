...
public sealed class CoreLayeringArchitectureTests
{
    ...
    {
        var offenders = ForbiddenReferences("Ashlar.Core.Domain", LayersForbiddenFromDomain);
    ...
    {
        var offenders = ForbiddenReferences("Ashlar.Core.Application", LayersForbiddenFromApplication);
