...
public sealed class GuiIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    {
        var resp = await _client.PostAsJsonAsync("/api/run", new RunRequestDto("/does/not/exist", ["a.hpp"], null, null, null, false, false, false, null, null));
    ...
    {
        var resp = await _client.PostAsJsonAsync("/api/run", new RunRequestDto(_fixturesRoot, [], null, null, null, false, false, false, null, null));
    ...
    public async Task Run_manifestOnly_skips_adaptation()
    {
        var req = new RunRequestDto(
            ...
            null, null, null, false, ManifestOnly: true, ExtractOnly: false, null, null);
    ...
    {
        static object[] T(string dir, string[] entries, string[]? includeDirs = null, string[]? defines = null) =>
            [dir, entries, includeDirs!, defines!];
    ...
    public async Task Run_end_to_end_via_http_for_tier(string dir, string[] entries, string[]? includeDirs, string[]? defines)
    {
        var req = new RunRequestDto(Path.Combine(_fixturesRoot, "stress", dir), entries, null, includeDirs, defines, false, false, false, null, null);
    ...
    private sealed record RunRequestDto(
        ...
        bool IncludeUpper, bool ManifestOnly, bool ExtractOnly, string? Model, int? MaxRetries,
        bool? RequireCompile = null, bool? PreferScaffold = null);
    ...
    private sealed record RunResponseDto(
        ...
        bool? CompileOk = null, string? CompileLog = null);
}
