...
public static class GeneratedBrickBuilder
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var projectDir = Path.Combine(Path.GetTempPath(), "nexo-gen-brick", Guid.NewGuid().ToString("N"));
        ...
        if (string.IsNullOrWhiteSpace(Environment.GetEnvironmentVariable("NEXO_CERT_NUGET_CONFIG")))
