...
/// Bound from the <c>Nexo:Pipelines:Execution</c> configuration section.
/// <para>
...
/// <para>
/// <b>Related:</b>
/// <see cref="NexoDefaults.PipelineMaxRetryAttempts"/> and
/// <see cref="NexoDefaults.PipelineRetryDelayMs"/> supply the default
/// values used here.
/// </para>
/// </summary>
public sealed class PipelineExecutionOptions
{
    ...
    /// </para>
    /// Override: <c>Nexo:Pipelines:Execution:ResumeFailedStages</c>.
    /// </summary>
    ...
    /// </list>
    /// Override: <c>Nexo:Pipelines:Execution:CompletionPolicy</c>.
    /// </summary>
    ...
    /// left on globally.
    /// Override: <c>Nexo:Pipelines:Execution:AllowMissingResumeSource</c>.
    /// </summary>
    ...
    /// trust boundary.
    /// </para>
    /// Override: <c>Nexo:Pipelines:Execution:EnableTestHooks</c>.
    /// </summary>
