...
/// <c>NEXO_CERT_DEV_HMAC_KEY</c>, every record is signed and verified with the COMMITTED
...
public sealed class CertificationRecordSigner
{
    ...
    /// <param name="hmacKey">Explicit HMAC key; null falls back to <c>NEXO_CERT_DEV_HMAC_KEY</c>, then the committed dev key.</param>
    ...
    /// no <c>NEXO_CERT_DEV_HMAC_KEY</c>): every signature this instance mints or accepts is
