...
public class ExecutionStateManager : IExecutionStateManager
{
    ...
    /// <summary>Initializes a new execution state manager.</summary>
    public ExecutionStateManager(ILogger<ExecutionStateManager> logger)
    {
        _logger = logger;
    }
    
    /// <summary>Sets provider.</summary>
    ...
    /// <summary>Gets current provider.</summary>
    ...
    /// <summary>Gets brick implementation.</summary>
