...
namespace Nexo.Infrastructure.Execution.Scratch;

/// <summary>
/// Snapshot-then-write <see cref="IManagedFileSet"/>: each relative path is
/// staged via <c>.nexo-tmp</c> then swapped into place. Rollback restores
