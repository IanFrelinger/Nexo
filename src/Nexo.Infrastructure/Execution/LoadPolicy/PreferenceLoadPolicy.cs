...
/// <summary>
/// Load policy that reads NEXO_LOAD_PREFERENCE and checks provider availability.
/// </summary>
public sealed class PreferenceLoadPolicy : ILoadPolicy
{
    ...
    {
        var env = Environment.GetEnvironmentVariable("NEXO_LOAD_PREFERENCE")?.Trim().ToLowerInvariant();
        return env switch
        {
