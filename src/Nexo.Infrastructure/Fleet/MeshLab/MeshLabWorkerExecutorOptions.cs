namespace Nexo.Infrastructure.Fleet.MeshLab;
...
public sealed class MeshLabWorkerExecutorOptions
{
    ...
    /// <summary>API key for director and assigned-peer calls; falls back to <c>Nexo:Security:ApiKey</c> when empty.</summary>
