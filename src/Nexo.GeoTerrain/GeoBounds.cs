...
public sealed record GeoBounds
{
    ...
    /// </summary>
    /// <param name="text">Bounds string in format "minLat,minLon,maxLat,maxLon"</param>
    /// <returns>Parsed GeoBounds</returns>
    ...
    /// </summary>
    /// <param name="text">Bounds string in format "minLat,minLon,maxLat,maxLon"</param>
    /// <param name="bounds">Parsed bounds if successful</param>
