...
// of AshlarHostingOptions.StrictMode, so it must be nameable by anyone who can
// name AshlarHostingOptions. See the note in AshlarHostingOptions.cs.
namespace Ashlar.Hosting;
/// <summary>
/// Controls Ashlar strict mode behavior. When enabled, the system fails fast with
...
///
/// Environment variable: <c>ASHLAR_STRICT_MODE</c> (<c>1</c> / <c>true</c> to enable).
/// </summary>
public sealed class StrictModeOptions
{
    ...
    /// </summary>
    public const string SectionName = "Ashlar:StrictMode";
