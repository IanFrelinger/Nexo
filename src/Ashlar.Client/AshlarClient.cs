...
/// <summary>
/// HTTP client implementation for Ashlar API.
/// </summary>
public sealed class AshlarClient : IAshlarClient
{
    ...
    /// <summary>
    /// Creates a client that issues HTTP requests against a configured Ashlar API host.
    /// </summary>
    /// <param name="httpClient">Pre-configured <see cref="HttpClient"/> with base address and auth headers.</param>
    public AshlarClient(HttpClient httpClient)
    {
