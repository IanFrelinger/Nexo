...
/// A reflection string (<c>Type.GetType("Ashlar.Policies…")</c>), a transitive dependency
...
/// <c>Ashlar.Core.Domain*</c> brick contracts every brick must reference) are always
...
#pragma warning restore RS1001
{
    ...
    public const string OutsideTouchSetId = "ASHLAR0013";

    /// <summary>Diagnostic id for an undeclared resolved reference into the trust kernel.</summary>
    public const string UndeclaredKernelReferenceId = "ASHLAR0014";
