...
public sealed class BrickInterfaceDriftAnalyzer : DiagnosticAnalyzer
{
    ...
    public const string UndeclaredInputId = "ASHLAR0001";

    /// <summary>Diagnostic id for writing an undeclared output key.</summary>
    public const string UndeclaredOutputId = "ASHLAR0002";

    private const string Category = "Ashlar.BrickContract";
    ...
    private sealed class KnownTypes
    {
        ...
        {
            var brick = compilation.GetTypeByMetadataName("Ashlar.Core.Domain.Bricks.Brick");
            var input = compilation.GetTypeByMetadataName("Ashlar.Core.Domain.Execution.BrickInput");
            var output = compilation.GetTypeByMetadataName("Ashlar.Core.Domain.Execution.BrickOutput");
            var iface = compilation.GetTypeByMetadataName("Ashlar.Core.Domain.Bricks.BrickInterface");
            var inputDef = compilation.GetTypeByMetadataName("Ashlar.Core.Domain.Bricks.BrickInputDefinition");
            var outputDef = compilation.GetTypeByMetadataName("Ashlar.Core.Domain.Bricks.BrickOutputDefinition");
