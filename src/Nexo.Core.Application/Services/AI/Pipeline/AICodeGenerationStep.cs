...
namespace Nexo.Core.Application.Services.AI.Pipeline
{
    ...
    public class AICodeGenerationStep : IPipelineStep<Nexo.Core.Domain.Entities.AI.CodeGenerationRequest>
    {
        ...
        public async Task<Nexo.Core.Domain.Entities.AI.CodeGenerationRequest> ExecuteAsync(
            Nexo.Core.Domain.Entities.AI.CodeGenerationRequest input, 
            Nexo.Core.Domain.Entities.Pipeline.PipelineContext context)
        {
            ...
            try
            {
                ...
                var aiContext = new AIOperationContext
                {
                    ...
                    Platform = ConvertToEnumsPlatformType(context.EnvironmentProfile.CurrentPlatform),
        ...
        public async Task<bool> CanExecuteAsync(Nexo.Core.Domain.Entities.AI.CodeGenerationRequest input, PipelineContext context)
        {
            try
            {
