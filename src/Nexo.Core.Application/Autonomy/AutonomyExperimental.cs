...
/// (self-extension) surface: this namespace, <c>Nexo.Infrastructure.Certification.HotSwap</c>,
/// <c>Nexo.Infrastructure.Autonomy</c> and <c>Nexo.BackgroundAgents.Autonomy</c>. Consumers that
/// opt in suppress <c>NEXOEXP001</c>; the certification gate itself is not part of this surface.
...
public static class AutonomyExperimental
{
    ...
    public const string DiagnosticId = "NEXOEXP001";

    /// <summary>Help link attached to the diagnostic (the policy section that explains it).</summary>
    public const string UrlFormat = "https://github.com/IanFrelinger/Nexo/blob/master/docs/SdkCompatibilityPolicy.md#nexoexp001";
}
