...
/// can override per-cycle caps via the <c>ASHLAR_BUILD_BUDGET</c> and
/// <c>ASHLAR_TEST_BUDGET</c> environment variables.</para>
///
...
public sealed class BuildTestBudget : IPolicy
{
    ...
    public BuildTestBudget(int? buildBudget = null, int? testBudget = null)
    {
        _buildBudget = buildBudget
            ?? ReadEnvBudget("ASHLAR_BUILD_BUDGET", DefaultBuildBudget);
        _testBudget = testBudget
            ?? ReadEnvBudget("ASHLAR_TEST_BUDGET", DefaultTestBudget);
    }
