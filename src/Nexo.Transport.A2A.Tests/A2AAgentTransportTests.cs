...
namespace Nexo.Transport.A2A.Tests;
...
public sealed class A2AAgentTransportTests
{
    ...
    [Fact]
    public void AddNexoA2ATransport_registers_nothing_when_disabled()
    {
        var configuration = new ConfigurationBuilder().Build();
        var services = new ServiceCollection();

        services.AddNexoA2ATransport(configuration);
    ...
    [Fact]
    public void AddNexoA2ATransport_contributes_the_scheme_registration_when_enabled()
    {
