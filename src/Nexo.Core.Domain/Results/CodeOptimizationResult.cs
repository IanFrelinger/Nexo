...
namespace Nexo.Core.Domain.Results
{
    ...
    public class CodeOptimizationResult
    {
        ...
        /// <summary>
        /// Warnings from the optimization
        /// </summary>
        ...
        /// </summary>
        public static CodeOptimizationResult Success(string? message = null)
        {
        ...
        /// </summary>
        public static CodeOptimizationResult Failure(string errorMessage, Exception? exception = null)
        {
            return new CodeOptimizationResult
            {
                IsSuccess = false,
