...
public sealed class InstanceCapabilities
{
    ...
    /// <summary>Available component IDs (e.g. ashlar-cli, ashlar-observe).</summary>
    ...
    /// <summary>
    /// Local Ashlar instance capabilities: can compile, supports Source/Binary/Config.
    /// </summary>
    public static InstanceCapabilities LocalAshlar { get; } = new(
        new[] { ArtifactFormat.Source, ArtifactFormat.Binary, ArtifactFormat.Config },
        ArtifactFormat.Source,
        canCompile: true,
        ...
        isAirGapped: false,
        availableComponents: new[] { "ashlar-cli", "ashlar-observe", "ashlar-improve" });
}
