...
public static class TrustKernel
{
    ...
    {
        "Ashlar.Infrastructure.Certification",
        "Ashlar.Core.Application.Certification",
        "Ashlar.Analyzers",
        "Ashlar.Policies",
        "Ashlar.BackgroundAgents.Security",
        "Ashlar.Core.Application.Execution",
        "Ashlar.Infrastructure.Execution.Sandbox",
        "Ashlar.Core.Application.Autonomy",
    };
