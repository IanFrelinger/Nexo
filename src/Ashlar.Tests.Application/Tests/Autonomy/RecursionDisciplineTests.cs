...
public sealed class RecursionDisciplineTests
{
    ...
    public void ChildrenInsideTheParentEnvelope_AreNotWidenings()
    {
        ...
        {
            PathPrefixes = ["src/Ashlar.Bricks.Weather/"],
            Namespaces = ["Ashlar.Bricks.Weather"],
            Capabilities = ["repo.fs.write", "dotnet.build"],
        };
        var child = new TouchSet
        {
            PathPrefixes = ["src/Ashlar.Bricks.Weather/Forecast/"],
            Namespaces = ["Ashlar.Bricks.Weather.Forecast"],
    ...
    public void EveryWideningDimension_IsNamed()
    {
        ...
        widenings.Should().Contain(w => w.Contains("src/Ashlar.Policies/"));
        widenings.Should().Contain(w => w.Contains("Ashlar.Policies"));
