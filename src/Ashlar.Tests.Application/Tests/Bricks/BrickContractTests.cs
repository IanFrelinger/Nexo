...
// Ashlar.Core.Domain.Bricks.Brick: the test namespace ends in .Bricks, which
// would otherwise shadow the type.

namespace Ashlar.Tests.Application.Tests.Bricks;

/// <summary>
/// Runtime backstop for the same drift class the ASHLAR0001/ASHLAR0002 analyzer
...
public sealed class BrickContractTests
{
    ...
    [
        ...
        typeof(Ashlar.Infrastructure.Execution.BrickRegistry).Assembly
    ];
    ...
    public async Task Executed_brick_emits_only_outputs_it_declares_deterministic_path()
    {
        ...
        services.AddLogging();
        services.AddAshlarGenerativeAgents();
        services.AddAshlarSqlAgentProfile();
