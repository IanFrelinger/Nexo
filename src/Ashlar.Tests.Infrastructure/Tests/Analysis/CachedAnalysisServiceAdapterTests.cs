...
using Ashlar.Infrastructure.Analysis.Adapters;
...
public class CachedAnalysisServiceAdapterTests : UnitTestBase
{
    ...
    private async Task TestCacheMiss()
    {
        ...
        var innerResult = new AnalysisResult
        {
            ...
            {
                new Violation { Rule = "TestRule", Message = "Test violation", FilePath = "test.cs", Severity = Ashlar.Core.Domain.Values.RiskLevel.Medium }
            },
            TotalViolations = 1
        };
