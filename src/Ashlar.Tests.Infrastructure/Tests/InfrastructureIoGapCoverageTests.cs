...
public class InfrastructureIoGapCoverageTests
{
    ...
    {
        var path = Path.Combine(Path.GetTempPath(), "ashlar-io-" + Guid.NewGuid() + ".txt");
    ...
    {
        var path = Path.Combine(Path.GetTempPath(), "ashlar-text-" + Guid.NewGuid() + ".txt");
        try
        {
    ...
    {
        var path = Path.Combine(Path.GetTempPath(), "ashlar-bin-" + Guid.NewGuid() + ".bin");
        try
        {
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "ashlar-dir-" + Guid.NewGuid());
