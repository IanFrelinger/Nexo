...
public sealed class ProductFleetTenantIsolationTests : IClassFixture<AshlarApiWebApplicationFactory>
{
    private readonly AshlarApiWebApplicationFactory _factory;

    public ProductFleetTenantIsolationTests(AshlarApiWebApplicationFactory factory) => _factory = factory;
    ...
    public async Task GET_copilot_task_returns_not_found_for_other_tenant()
    {
        ...
        request.Headers.TryAddWithoutValidation(AshlarHttpTenant.TenantHeaderName, "tenant-b");
    ...
    public async Task GET_copilot_tasks_lists_only_resolved_tenant()
    {
        ...
        request.Headers.TryAddWithoutValidation(AshlarHttpTenant.TenantHeaderName, "tenant-a");
