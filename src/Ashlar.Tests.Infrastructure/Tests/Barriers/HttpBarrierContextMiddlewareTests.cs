...
public sealed class HttpBarrierContextMiddlewareTests : IDisposable
{
    ...
    {
        _savedEnvVar = Environment.GetEnvironmentVariable("ASHLAR_BARRIER_MIDDLEWARE_ENABLED");
    }

    public void Dispose()
    {
        Environment.SetEnvironmentVariable(
            "ASHLAR_BARRIER_MIDDLEWARE_ENABLED",
            _savedEnvVar);
    }
    ...
    {
        Environment.SetEnvironmentVariable("ASHLAR_BARRIER_MIDDLEWARE_ENABLED", null);
    ...
    {
        Environment.SetEnvironmentVariable("ASHLAR_BARRIER_MIDDLEWARE_ENABLED", "true");
        ...
        var nextCalled = false;
        await middleware.InvokeAsync(new DefaultHttpContext { RequestServices = serviceProvider }, _ =>
        {
            nextCalled = true;
            return Task.CompletedTask;
        });
    ...
    {
        Environment.SetEnvironmentVariable("ASHLAR_BARRIER_MIDDLEWARE_ENABLED", "1");
    ...
    public async Task Enabled_builds_resolution_context_from_headers_jwt_claims_and_certificate()
    {
        ...
        context.Request.Headers["x-ashlar-barrier"] = "internal";
    ...
    {
        Environment.SetEnvironmentVariable("ASHLAR_BARRIER_MIDDLEWARE_ENABLED", "false");
    ...
    public async Task Enabled_copies_all_request_headers_into_resolution_context()
    {
        ...
        context.Request.Headers["x-ashlar-barrier"] = "public";
    ...
    {
        Environment.SetEnvironmentVariable("ASHLAR_BARRIER_MIDDLEWARE_ENABLED", "yes");
