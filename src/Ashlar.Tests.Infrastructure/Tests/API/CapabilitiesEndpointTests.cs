...
public sealed class CapabilitiesEndpointTests
{
    ...
    private sealed class StubNodeCapabilityRuntime : INodeCapabilityRuntime
    {
        ...
        public Task RecordOutcomeAsync(ModelResolution resolution, Ashlar.Core.Application.Execution.Ports.BrickExecutionOutcome outcome, CancellationToken ct = default)
            => Task.CompletedTask;
