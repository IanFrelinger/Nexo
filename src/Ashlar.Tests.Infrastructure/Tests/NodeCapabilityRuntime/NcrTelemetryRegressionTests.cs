...
public sealed class NcrTelemetryRegressionTests
{
    ...
    private sealed class FixedHardwareProfiler : Ashlar.Core.Application.NodeCapabilityRuntime.Ports.IHardwareProfiler
    {
    ...
    private sealed class StubModelServingBackend : Ashlar.Core.Application.NodeCapabilityRuntime.Ports.IModelServingBackend
    {
