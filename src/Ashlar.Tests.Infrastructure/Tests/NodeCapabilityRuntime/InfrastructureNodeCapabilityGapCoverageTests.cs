...
public class InfrastructureNodeCapabilityGapCoverageTests
{
    ...
    {
        var observableType = typeof(Ashlar.Infrastructure.NodeCapabilityRuntime.NodeCapabilityRuntime).Assembly
            .GetType("Ashlar.Infrastructure.NodeCapabilityRuntime.SimpleObservable`1")!
