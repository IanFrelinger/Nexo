...
public sealed class SessionSandboxAdversarialCampaignTests
{
    ...
    public async Task Attack_stripping_the_deadline_label_makes_the_reaper_MORE_aggressive()
    {
        ...
        {
            if (args[0] == "ps")
                return new ProcessCommandResult(0, "ashlar-session-stripped\t\nashlar-session-garbled\tsoon\n", "");
            removed.Add(args[2]);
        ...
        reaped.Should().BeEquivalentTo("ashlar-session-stripped", "ashlar-session-garbled");
