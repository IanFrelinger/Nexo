...
/// <summary>
/// In-process <see cref="Ashlar.API"/> host using the full ASP.NET Core pipeline and DI graph (same assembly as production).
...
/// </summary>
public sealed class AshlarApiWebApplicationFactory : WebApplicationFactory<Program>
{
