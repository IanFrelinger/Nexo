...
public sealed class OllamaBackendOptions
{
    ...
    public const string SectionName = "Ashlar:NodeCapabilityRuntime:Ollama";
    ...
    /// <c>ASHLAR_OLLAMA_BASE_URL</c> env → <c>Ashlar:NodeCapabilityRuntime:Ollama:BaseUrl</c> config →
    ...
    public static string ResolveBaseUrl(string? configuredBaseUrl)
    {
        foreach (var candidate in new[]
                 {
                     Environment.GetEnvironmentVariable("ASHLAR_OLLAMA_BASE_URL"),
                     configuredBaseUrl,
