...
internal static partial class MockScaffoldingResponder
{
    ...
    private static string BuildUiFeatureHotloadToolCallsJson(string systemPrompt, string objective)
    {
        ...
        {
            var descriptorPath = $"docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.AvaloniaHost/GeneratedExtensions/{slug}.json";
    ...
    private static string BuildUiDemoToolCallsJson(string systemPrompt)
    {
        ...
        var calls = new List<object>
        {
            ...
            CreateWriteCall(root, "docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.Abstractions/Ashlar.Ui.Abstractions.csproj", BuildAvaloniaAbstractionsProjectSource()),
            CreateWriteCall(root, "docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.Abstractions/UiContracts.cs", BuildAvaloniaUiContractsSource()),
            CreateWriteCall(root, "docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.AvaloniaHost/Ashlar.Ui.AvaloniaHost.csproj", BuildAvaloniaHostProjectSource()),
            CreateWriteCall(root, "docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.AvaloniaHost/Program.cs", BuildAvaloniaHostProgramSource()),
            CreateWriteCall(root, "docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.AvaloniaHost/GeneratedExtensions/.gitkeep", string.Empty),
            CreateWriteCall(root, "docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.AvaloniaHost/README.md", BuildAvaloniaHostReadmeSource()),

            // Command-structure scaffolding for composable extension commands.
            CreateWriteCall(root, "application/src/Ashlar.CLI/Commands/SelfExtendGenerated/IComposableExtensionCommand.cs", BuildComposableCommandContractSource()),
        };
        ...
        foreach (var ext in extensionCommands)
        {
            calls.Add(CreateWriteCall(
                root,
                $"application/src/Ashlar.CLI/Commands/SelfExtendGenerated/{ext.ClassName}.cs",
                BuildExtensionCommandSource(ext.ClassName, ext.CommandName, ext.ExtensionId, ext.Dependencies)));
        }

        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.CLI/Commands/SelfExtendGenerated/SelfExtendUiDemoBundleCommand.cs",
        ...
        foreach (var ext in extensionCommands)
        {
            calls.Add(CreateWriteCall(
                root,
                $"application/src/Ashlar.Tests.CLI/Tests/Commands/SelfExtendGenerated/{ext.ClassName}StructureTests.cs",
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.Tests.CLI/Tests/Commands/SelfExtendGenerated/SelfExtendUiDemoBundleCommandStructureTests.cs",
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.Tests.CLI/Tests/Commands/SelfExtendGenerated/UiDomainKnowledgeRetentionTests.cs",
    ...
    private static string BuildPersonalAppToolCallsJson(string systemPrompt)
    {
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.CLI/Commands/SelfExtendGenerated/SelfExtendPersonalBundleCommand.cs",
            BuildBundleCommandSource(
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.Tests.CLI/Tests/Commands/SelfExtendGenerated/SelfExtendPersonalBundleCommandStructureTests.cs",
            BuildBundleCommandStructureTestSource(
    ...
    private static string BuildComposableBackendToolCallsJson(string systemPrompt)
    {
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.CLI/Commands/SelfExtendGenerated/SelfExtendBackendBundleCommand.cs",
            BuildBundleCommandSource(
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.Tests.CLI/Tests/Commands/SelfExtendGenerated/SelfExtendBackendBundleCommandStructureTests.cs",
            BuildBundleCommandStructureTestSource(
...
""";
        ...
        calls.Add(CreateWriteCall(root, "application/src/Ashlar.CLI/Commands/SelfExtendGenerated/IComposableExtensionCommand.cs", BuildComposableCommandContractSource()));
        foreach (var ext in extensionCommands)
        {
            calls.Add(CreateWriteCall(
                root,
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.CLI/Commands/SelfExtendGenerated/SelfExtendBundleCommand.cs",
        ...
        calls.Add(CreateWriteCall(
            root,
            "application/src/Ashlar.Tests.CLI/Tests/Commands/SelfExtendGenerated/SelfExtendBundleCommandStructureTests.cs",
            BuildBundleCommandStructureTestSource(
    ...
    /// (e.g. <c>ashlar validate</c> / UnitTestBridge without a prior <c>self-extend</c> run).
    /// </summary>
    internal static void EnsureUiDomainDemoBaseline(string repoRoot)
    {
        ...
        Write("docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.Abstractions/UiContracts.cs", BuildAvaloniaUiContractsSource());
        Write("docs/UiDomainDemoGenerated/avalonia/Ashlar.Ui.AvaloniaHost/Program.cs", BuildAvaloniaHostProgramSource());
    }
