...
namespace Ashlar.Infrastructure.Execution.Agentic;
...
public sealed class NcrAgenticBrickEngine : IAgenticBrickEngine
{
    ...
    internal static TaskContext MapBrickToTaskContext(DomainBrick brick, IExecutionContext context)
    {
        ...
        var isUserFacing = context.Variables.TryGetValue("ashlar:user_facing", out var userFacingObj) &&
                           userFacingObj is bool userFacing &&
                           userFacing;
        var quality = ParseEnumVariable(context.Variables, "ashlar:quality", QualityRequirement.Medium);
        ...
        var privacy = (context.IsAirGapped || context.AuditMode)
            ...
            : ParseEnumVariable(context.Variables, "ashlar:privacy", PrivacyBoundary.Standard);
        ...
        return new TaskContext
        {
            ...
            IsDelegationTask = context.Variables.ContainsKey("ashlar:delegation"),
