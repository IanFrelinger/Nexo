...
public class WorkflowExporter : IWorkflowExporter
{
        ...
        CancellationToken ct)
    {
        ...
        if (config.Output.Format == Ashlar.Core.Domain.Export.OutputFormat.Project)
        {
    ...
    {
        var files = new List<ExportedFile>();
        var requirements = new List<string> { "Ashlar.Runtime" };
        ...
        {
            requirements.Add($"Ashlar.Provider.{provider}");
        }
