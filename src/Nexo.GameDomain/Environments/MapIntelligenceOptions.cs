...
{
    /// <summary>Use <see cref="Nexo.Core.Application.Environments.Ports.IVectorMapIntelligenceService"/> after fetch.</summary>
    public bool RefineVectorWithEmbeddedAi { get; init; }

    /// <summary>Use <see cref="Nexo.Core.Application.Environments.Ports.IMaterialIntelligenceService"/> for facade/road materials.</summary>
    public bool SuggestMaterialsWithEmbeddedAi { get; init; }

    /// <summary>Run <see cref="Nexo.Core.Application.Environments.Ports.IMapVerificationService"/> per LOD tier.</summary>
