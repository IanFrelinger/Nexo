...
{
    /// <summary>
    /// Repository root (contains Nexo.sln).
    /// </summary>
    ...
    /// </summary>
    /// <param name="prefix">Prefix for the temp dir (e.g. "nexo-phases59-e2e").</param>
    protected E2ETestBase(string prefix = "nexo-e2e") : base(prefix)
    {
