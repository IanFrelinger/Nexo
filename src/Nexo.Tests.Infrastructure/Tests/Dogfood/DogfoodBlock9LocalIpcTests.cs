...
/// <summary>
/// Phase E: Instance Mesh Dogfood (Block 9). Validates two Nexo instances on the same machine
...
public sealed class DogfoodBlock9LocalIpcTests : IDisposable
{
    ...
    {
        (_tempDir, _tempDirCleanup) = TestHelpers.CreateTempDirectoryWithCleanup("nexo-dogfood-block9-ipc");
    ...
    {
        const string capabilityId = "nexo-test-helper";
        ...
        {
            new CapabilityDescriptor { Id = capabilityId, Name = "Nexo Test Helper" },
        });
