...
using SecurityFinding = Nexo.Demo.Bricks.Security.SecurityFinding;
using ScanMetadata = Nexo.Demo.Bricks.Security.ScanMetadata;
using Nexo.Infrastructure.Execution;

namespace Nexo.Tests.Infrastructure.Tests.Demo;
