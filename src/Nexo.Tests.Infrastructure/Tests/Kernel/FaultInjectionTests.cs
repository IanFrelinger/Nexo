...
public sealed class FaultInjectionTests : IDisposable
{
    ...
    {
        (_, _tempDirCleanup) = TestHelpers.CreateTempDirectoryWithCleanup("nexo-fault-injection");
    }
    ...
    {
        var (tempDir, _) = TestHelpers.CreateTempDirectoryWithCleanup("nexo-rollback-fault");
