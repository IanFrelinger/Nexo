...
public sealed class MeshLabWorkerExecutorClientGapCoverageTests
{
    ...
    [Theory]
    [InlineData(null, MeshTaskStatus.Assigned, false)]
    ...
    public void IsStatus_treats_blank_or_case_insensitive_values(string? status, MeshTaskStatus expected, bool match)
    {
