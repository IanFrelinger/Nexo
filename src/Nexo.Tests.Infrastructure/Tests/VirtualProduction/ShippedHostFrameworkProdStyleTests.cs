...
/// </summary>
/// <remarks>
/// `Nexo.API` multi-targeted for a while, purely so the `net8.0` leg of this test project could link
/// it. The visible cost was that `dotnet run --project application/src/Nexo.API` refused to start —
...
public sealed class ShippedHostFrameworkProdStyleTests
{
    ...
    [InlineData("application/src/Nexo.API/Nexo.API.csproj")]
    [InlineData("application/src/Nexo.CLI/Nexo.CLI.csproj")]
