...
/// <summary>
/// Options for consuming external MCP servers as Nexo tools.
///
...
/// </summary>
public sealed class NexoMcpClientOptions
{
    /// <summary>Default configuration section (<c>Nexo:Mcp:Client</c>).</summary>
    public const string SectionPath = "Nexo:Mcp:Client";
