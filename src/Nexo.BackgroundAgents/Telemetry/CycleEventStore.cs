...
namespace Nexo.BackgroundAgents.Telemetry;
...
/// <c>nexo background-agent stats</c> CLI) to read. Each entry captures enough
...
/// <c>&lt;repo&gt;/.nexo/runtime-studio/cycles.jsonl</c>. Parent directories are
...
public sealed class CycleEventStore
{
    ...
    /// </summary>
    public const string DefaultRelativePath = ".nexo/runtime-studio/cycles.jsonl";
