...
///
/// <para>Storage layout mirrors <see cref="Nexo.BackgroundAgents.Objectives.ObjectiveDocument"/>:
/// each proposal lives as a JSON file under
/// <c>.nexo/runtime-studio/forge/{proposed|approved|rejected|applied|stale}/{id}.json</c>,
