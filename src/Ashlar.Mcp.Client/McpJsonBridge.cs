...
/// <summary>
/// Pure conversion helpers between Ashlar tool-call shapes and MCP client shapes.
...
{
    /// <summary>
    /// Converts a Ashlar <see cref="ToolCall.Arguments"/> element into the argument dictionary the
    ...
    /// <summary>
    /// Maps a remote <see cref="CallToolResult"/> onto a Ashlar <see cref="ToolResult"/>:
