...
namespace Ashlar.Tests.BackgroundAgents.Playground;
...
public sealed class RuntimeStudioWhiteBoxPlaygroundTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "ashlar-wb-play-" + Guid.NewGuid().ToString("N"));
