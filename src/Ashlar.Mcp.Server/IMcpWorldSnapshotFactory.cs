...
/// <see cref="AshlarMcpServerOptions.RepoRoot"/> (falling back to the process working directory),
...
public sealed class OptionsMcpWorldSnapshotFactory : IMcpWorldSnapshotFactory
{
    ...
    public OptionsMcpWorldSnapshotFactory(IOptions<AshlarMcpServerOptions> options) => _options = options;
