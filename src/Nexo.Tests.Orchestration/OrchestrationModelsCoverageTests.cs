...
public class OrchestrationModelsCoverageTests
{
    ...
    public void ConfigurationValidator_reports_errors_and_warnings()
    {
        var config = new ConfigurationBuilder()
            ...
            {
                ["Nexo:Orchestration:MaxRetries"] = "11",
                ["Nexo:Orchestration:DefaultTimeout"] = "30",
                ["Nexo:Orchestration:UseLLM"] = "true",
            })
            .Build();
        ...
        var good = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["Nexo:Orchestration:MaxRetries"] = "3",
                ["Nexo:Orchestration:DefaultTimeout"] = "60",
            })
            .Build();
