...
The scaffold certifies exactly as generated:
...
project needs **no** `CopyLocalLockFileAssemblies` — the gate reads references from the compiler's
own record of the build, not from the output folder.
