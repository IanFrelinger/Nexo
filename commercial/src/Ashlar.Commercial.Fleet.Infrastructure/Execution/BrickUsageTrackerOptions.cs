...
public class BrickUsageTrackerOptions
{
    ...
    public int MaxEntries { get; set; } = AshlarDefaults.BrickUsageTrackerMaxEntries;

    /// <summary>Rolling window for ExecutionsPerHour (seconds). Default 3600 (1 hour).</summary>
    public int RollingHourWindowSeconds { get; set; } = AshlarDefaults.BrickUsageTrackerRollingHourWindowSeconds;
}
