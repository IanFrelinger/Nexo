...
using Ashlar.Commercial.Fleet.Infrastructure.Communication;
using Ashlar.Commercial.Fleet.Infrastructure.MeshLab;
...
{
    /// <summary>Add ashlar fleet director operation.</summary>
    /// <summary>Registers Phase 1 mesh director services and background workers.</summary>
    public static IServiceCollection AddAshlarFleetDirector(
    ...
    /// </summary>
    public static IServiceCollection AddAshlarMeshElasticScheduling(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    /// </summary>
    public static IServiceCollection AddAshlarMeshCheckpointScheduling(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    /// </summary>
    public static IServiceCollection AddAshlarMeshKnowledgeReplication(
        this IServiceCollection services,
    ...
    /// Call after <c>AddAshlarOrchestration</c> when cross-node networking is required.
    /// </summary>
    public static IServiceCollection AddAshlarCommercialFleetNetworking(
        this IServiceCollection services,
        IConfiguration? configuration = null)
    {
        if (configuration is not null)
    ...
    /// <summary>
    /// Registers the bridge between <see cref="Ashlar.Orchestration.Communication.IAgentBus"/> and <see cref="Ashlar.Commercial.Fleet.Contracts.Networking.Ports.INetworkBus"/>.
    /// </summary>
    public static IServiceCollection AddAgentBusNetworkBridge(
        this IServiceCollection services,
        IConfiguration? configuration = null)
        => services.AddAshlarCommercialFleetNetworking(configuration);
}
