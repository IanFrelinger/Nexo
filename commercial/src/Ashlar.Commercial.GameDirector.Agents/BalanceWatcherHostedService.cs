...
public sealed class BalanceWatcherHostedService : BackgroundService
{
    ...
    private readonly Ashlar.Core.Domain.Execution.IBrickRegistry _bricks;
    ...
    public BalanceWatcherHostedService(
        ...
        Ashlar.Core.Domain.Execution.IBrickRegistry bricks,
    ...
    private async Task ScanBalanceSheetsAsync(CancellationToken ct)
    {
        ...
        foreach (var file in Directory.EnumerateFiles(dir, "*.json"))
        {
            ...
            var context = new Ashlar.Infrastructure.Execution.ExecutionContext { AgentId = "balance-watcher" };
