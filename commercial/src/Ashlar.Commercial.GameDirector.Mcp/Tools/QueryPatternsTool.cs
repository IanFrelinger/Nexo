...
{
    private readonly IAshlarClient _client;

    /// <summary>Query patterns tool.</summary>
    /// <param name="client">Client.</param>
    public QueryPatternsTool(IAshlarClient client) => _client = client;

    public string Name => "query_patterns";
    public string Description => "Query the Ashlar pattern store for learned insights.";
