...
public sealed class HostedServiceLifecycleTests
{
    ...
    private sealed class EmptyBrickRegistry : IBrickRegistry
    {
        ...
        public Ashlar.Core.Domain.Bricks.Brick? GetBrick(string id) => null;
        /// <summary>Gets all bricks.</summary>
        public IReadOnlyList<Ashlar.Core.Domain.Bricks.Brick> GetAllBricks() => [];
        /// <summary>Register.</summary>
        /// <param name="brick">Brick.</param>
        public void Register(Ashlar.Core.Domain.Bricks.Brick brick) { }
    }
}
