...
{
    [Fact]
    public void BrickUsageTrackerOptions_UsesAshlarDefaults()
    {
        var opts = new BrickUsageTrackerOptions();
        opts.MaxEntries.Should().Be(AshlarDefaults.BrickUsageTrackerMaxEntries);
        opts.RollingHourWindowSeconds.Should().Be(AshlarDefaults.BrickUsageTrackerRollingHourWindowSeconds);
    }
