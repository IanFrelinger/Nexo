// NexoConsole.cs — terminal styling for the nexo CLI
// Palette: ink #2B2420 · cream #F7F2E5 · sage #7E8F6E · gold #D1A23C · clay #C96F4A · olive #8A8069
//
// Rules of the road (see nexo-terminal-style.md):
...
public static class NexoConsole
{
    // ---- palette -----------------------------------------------------------
...
NexoConsole.EnableVirtualTerminal();
NexoConsole.Banner("0.7.0");
NexoConsole.Chain();

NexoConsole.Rule("boot");
NexoConsole.Info("loaded 42 bricks", right: "12ms");
NexoConsole.Info("composed 7 behaviors", right: "4ms");
NexoConsole.Certified("certification chain verified", right: "ed25519 ✓");
NexoConsole.Warn("skills approval pending", " · human gate");
NexoConsole.Error("rejected unsigned brick", " · fail-closed");
NexoConsole.Rule("ready");
NexoConsole.Certified("nexo is certified & listening");
