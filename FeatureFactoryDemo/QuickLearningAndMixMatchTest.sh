...
# Quick Learning and Mix-and-Match Test
# Demonstrates the Feature Factory's learning capabilities and mix-and-match quality
# Pushes the system with complex, evolving scenarios

echo "🧠 QUICK LEARNING AND MIX-AND-MATCH TEST"
echo "========================================"
echo "Testing Feature Factory's learning capabilities and mix-and-match quality"
echo "Pushing the system with complex, evolving scenarios"
echo ""
...
dotnet run generate --description "Create a hybrid system combining Java User management (User entity, UserRepository, UserService, UserController) with Python Product management (Product entity, ProductRepository, ProductService, ProductController) and .NET Order management (Order entity, OrderRepository, OrderService, OrderController) with API integration, data synchronization, and cross-platform communication" --platform Java --target-score 90 --max-iterations 20
...
# =============================================================================
# PHASE 6: STRESS TEST: PUSHING THE LIMITS
# =============================================================================

echo "💥 PHASE 6: STRESS TEST - PUSHING THE LIMITS"
echo "==========================================="
...
echo "🎯 QUICK LEARNING AND MIX-AND-MATCH TEST RESULTS"
echo "==============================================="
