...
- **Open API fleet cleanup:** removed `/api/mesh/fleet/**`, `/api/mesh/tasks/**`, and `/api/mesh/knowledge/**` endpoint duplicates from open `Nexo.API`; commercial fleet endpoints now live in `Nexo.Commercial.Fleet.Api`.
